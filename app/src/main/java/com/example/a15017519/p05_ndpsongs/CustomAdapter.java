...
public class CustomAdapter extends ArrayAdapter<Song> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        iv2 = (ImageView) rowView.findViewById(R.id.imageView);
        iv3 = (ImageView) rowView.findViewById(R.id.imageView);
        iv4 = (ImageView) rowView.findViewById(R.id.imageView);
        iv5 = (ImageView) rowView.findViewById(R.id.imageView);
        tvSinger = (TextView) rowView.findViewById(R.id.textViewComposer);
        tvTitle = (TextView) rowView.findViewById(R.id.textViewSong);
